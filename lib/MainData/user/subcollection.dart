...
import '../usercontrol/product_details.dart';


class Products extends StatefulWidget {
  final product_detail_name;
  final product_detail_uid;
 

  Products({
    this.product_detail_name,
    this.product_detail_uid,
...
class _ProductsState extends State<Products> {
  ...
  Future getPosts() async{
   ...
   QuerySnapshot qn = await firestore.collection("users").document(widget.product_detail_uid).collection('products').getDocuments() ;
    return qn.documents;
  }
  // String arpit= widget.product_detail_uid;
  @override
void initState()
{
 super.initState(); 
